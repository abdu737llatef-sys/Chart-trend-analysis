const CACHE='trend-v5-6-4-20260919';
const CORE=['./style.css?v=5.6.4','./app.js?v=5.6.4','./scanner.html?v=5.6.4','./scanner.js?v=5.6.4.2','./manifest.webmanifest?v=5.6.4','./icon-192.png','./icon-512.png'];
