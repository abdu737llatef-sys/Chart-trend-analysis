const CACHE='trend-v5-6-7-6-20260922';
const CORE=[
 './style.css?v=5.6.7.6',
 './decision-engine.js?v=5.6.7.6',
 './app.js?v=5.6.7.6',
 './scanner.html?v=5.6.7.6',
 './scanner.js?v=5.6.7.6',
 './manifest.webmanifest?v=5.6.7.6',
...
self.addEventListener('fetch',e=>{
 ...
 const dynamic=e.request.mode==='navigate'||/\/(index\.html|app\.js|scanner\.js|decision-engine\.js|style\.css|manifest\.webmanifest)$/.test(u.pathname);
 if(dynamic){
