const CACHE='trend-v5-6-6-20260919';
const CORE=['./style.css?v=5.6.6','./app.js?v=5.6.6','./scanner.html?v=5.6.6','./scanner.js?v=5.6.6','./manifest.webmanifest?v=5.6.6','./icon-192.png','./icon-512.png'];
