const CACHE='trend-v5-6-6-1-20260920';
const CORE=['./style.css?v=5.6.6.1','./app.js?v=5.6.6.1','./scanner.html?v=5.6.6.1','./scanner.js?v=5.6.6.1','./manifest.webmanifest?v=5.6.6.1','./icon-192.png','./icon-512.png'];
