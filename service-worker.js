const CACHE='trend-v5-6-3-20260913';
const CORE=['./style.css?v=5.6.3','./app.js?v=5.6.3','./scanner.html?v=5.6.3','./scanner.js?v=5.6.3.2','./manifest.webmanifest?v=5.6.3','./icon-192.png','./icon-512.png'];
