const CACHE='trend-v5-6-5-20260919';
const CORE=['./style.css?v=5.6.5','./app.js?v=5.6.5','./scanner.html?v=5.6.5','./scanner.js?v=5.6.5','./manifest.webmanifest?v=5.6.5','./icon-192.png','./icon-512.png'];
