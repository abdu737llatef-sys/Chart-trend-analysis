const CACHE='trend-v5-6-7-20260920';
const CORE=['./style.css?v=5.6.7','./app.js?v=5.6.7','./scanner.html?v=5.6.7','./scanner.js?v=5.6.7','./manifest.webmanifest?v=5.6.7','./icon-192.png','./icon-512.png'];
